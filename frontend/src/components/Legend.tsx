function Legend() {
  return (
    <div className="absolute bottom-0 z-10 bg-[#fcfffd]/90 dark:bg-slate-900/90 backdrop-blur-md rounded-r-lg rounded-b-none shadow-sm px-2.5 py-2 text-[10px] w-16">
      <div className="font-semibold mb-1.5 text-slate-500 dark:text-slate-400">Speed (kn)</div>
